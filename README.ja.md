...
設定、認証情報、診断、Windows Service管理には`githubie.exe`を使います。MCP ClientにはRepository Status、fetch／pull／push、Branch、Pull Request、Tag、Version取得の15個の型付きToolを公開します。詳細は[コマンド](COMMANDS.ja.md)を参照してください。
