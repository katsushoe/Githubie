...
Githubie uses four-part display versions: `major.minor.patch.revision`. MSI comparison uses the first three parts. The current display version is `1.2.0.0`.
...
Version `1.2.0.0` adds draft-first GitHub Release creation and bounded MSI/ZIP/SHA-256 asset uploads. ADR 0015 records the publication model.
